...
teff= "012800" #hard coded for test target
#logg= 8.0 #model values to pull (should be changed to be read from somewhere in the future)
logg = "775" #hard coded for test target(it was 7.8 in the paper, but that is technically the same as this gridpoint to two sig figs)
